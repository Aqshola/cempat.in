  ...
  return (
    <div className="w-full grid grid-cols-2 h-screen">
      <div className="col-span-2 md:col-span-1 flex flex-col px-16 py-28 items-center">
        <h1 className="text-4xl font-semibold text-[#03C88E]">Halo!</h1>
        <h1 className="text-lg text-[#03C88E] mt-2">Selamat Datang</h1>
        ...
        <p  className="mt-auto text-sm text-gray-500">Sudah punya akun? <Link to="/login" className="font-semibold text-[#03C88E]">Yuk Masuk</Link> </p>
      </div>
