...
function Login() {
  ...
  return (
    <div className="bg-green-primary h-screen py-8 px-7 md:px-32">
      <div className="md:w-[450px] mx-auto">
        ...
        <div className="mt-5 mx-auto bg-white py-16 px-5 rounded-lg shadow-auth-box">
          ...
          <p className="text-center text-sm font-light my-4 font-nunito">atau</p>
          <Button variant="outline-gray" className="w-full flex justify-center gap-5">
            <span>
              <img src="/icon/filled/google-icon-filled.svg" alt="google" />
            </span>
            Login dengan Google</Button>
            <p className="mt-2 text-sm text-center">Belum punya akun? <Link to={"/register"} className="font-bold">Yuk gabung</Link></p>
        </div>
      </div>
    </div>
