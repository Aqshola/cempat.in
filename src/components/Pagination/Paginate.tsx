  ...
  return (
    ...
    >
        ...
        >
          {slicedArray.map((el) => (
            <button
              ...
              key={el + 1}
              className={clsx(
                "border w-9 h-9 text-sm flex justify-center items-center rounded-lg p-2  font-nunito",
                active !== el + 1 && [
      ...
      >
        ...
        <button
          onClick={() => _handlePage(props.totalPage)}
          disabled={active === props.totalPage}
          className="border-gray-100 w-7 h-7 text-sm flex justify-center items-center rounded-lg  font-nunito"
        >
